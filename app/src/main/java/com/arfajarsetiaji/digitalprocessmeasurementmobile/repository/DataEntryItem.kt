...
@Parcelize
data class DataEntries(@SerializedName("Sheet1") val dataEntryItems: MutableList<DataEntryItem?>?): Parcelable

@Parcelize
@Entity(tableName = "Data Entries")
data class DataEntryItem(
    @SerializedName("no") @ColumnInfo(name = "no") val no: Int?,
    @SerializedName("jid_no") @ColumnInfo(name = "jid_no") val jid_no: String?,
    ...
    @SerializedName("qty") @ColumnInfo(name = "qty") val qty: String?,
