...
object AppPreferences {
    ...
    var notFirstRun: Boolean
        get() = sharedPreferences.getBoolean(
            IS_NOT_FIRST_RUN_PREF.first, IS_NOT_FIRST_RUN_PREF.second)
        set(value) = sharedPreferences.edit { it.putBoolean(
            IS_NOT_FIRST_RUN_PREF.first, value)
        }

    var userLoggedIn: Boolean
        get() = sharedPreferences.getBoolean(
            IS_USER_LOGGED_IN_PREF.first, IS_USER_LOGGED_IN_PREF.second)
        set(value) = sharedPreferences.edit { it.putBoolean(
            IS_USER_LOGGED_IN_PREF.first, value)
        }

    var userWorkCenter: String?
        get() = sharedPreferences.getString(
            USER_WORK_CENTER_PREF.first, USER_WORK_CENTER_PREF.second)
        set(value) = sharedPreferences.edit { it.putString(
            USER_WORK_CENTER_PREF.first, value)
        }
}